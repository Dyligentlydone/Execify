...
const FROM_EMAIL = process.env.RESEND_FROM_EMAIL || "hello@execufy.com";
...
export async function sendWelcomeEmail(email: string, firstName: string) {
  return sendEmail({
    to: email,
    subject: "Welcome to Execufy 🚀",
    html: `
      <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto;">
        <h1 style="color: #18181b;">Welcome to Execufy, ${firstName}!</h1>
...
export async function sendOrgInviteEmail(
  ...
  return sendEmail({
    to: email,
    subject: `You've been invited to ${orgName} on Execufy`,
    html: `
      <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto;">
        <h1 style="color: #18181b;">You're invited!</h1>
        <p style="color: #52525b; line-height: 1.6;">
          ${inviterName} has invited you to join <strong>${orgName}</strong> on Execufy.
        </p>
...
export async function sendSubscriptionUpdateEmail(
  ...
  return sendEmail({
    to: email,
    subject: `Your Execufy plan has been updated`,
    html: `
      <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto;">
